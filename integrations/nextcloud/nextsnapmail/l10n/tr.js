OC.L10N.register(
    ...
    "Simple, modern and fast web-based email client. After enabling in Nextcloud, go to Nextcloud admin panel, \"Additionnal settings\" and you will see a \"Rainloop webmail\" section. There, click on the link to go to the Rainloop admin panel. The default user/password is admin/12345. This version is based on Rainloop 1.16.0 (2021-05)." : "Basit, modern ve hızlı web tabanlı e-posta istemcisi. Nextcloud üzerinde etkinleştirdikten sonra, Nextcloud yönetim panosunda \"Ek ayarlar\" içinde \"RainLoop Webmail\" bağlantısını göreceksiniz. RainLoop yönetim panosuna gitmek için bağlantıya tıklayın. Varsayılan kullanıcı adı/parola, admin/12345 şeklindedir. Bu uygulamada RainLoop 1.16.0 (2021-05) sürümü temel alınmıştır.",
